...
- **AI 行事曆。** 截圖 → AI → Apple Calendar；需要 Calendar Full Access 和自行設定的 OpenAI-compatible API，辨識結果寫入「工作」或「個人」行事曆前必須人工確認
...
- Calendar Full Access：首次使用 AI 行事曆時授予，用於將確認後的行程寫入所選的「工作」或「個人」行事曆
