...
- **AI 日历。** 截图 → AI → Apple Calendar；需要 Calendar Full Access 和用户自行配置的 OpenAI-compatible API，识别结果写入“工作”或“个人”日历前必须人工确认
...
- Calendar Full Access：首次使用 AI 日历时授予，用于将确认后的日程写入所选的“工作”或“个人”日历
