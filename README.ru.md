...
- **AI-календарь**: скриншот → ИИ → Apple Calendar с обязательной проверкой перед добавлением. Требуются полный доступ к Календарю и самостоятельно настроенный OpenAI-совместимый API; по умолчанию используются календари Work и Personal
...
- Полный доступ к Календарю, запрашиваемый при первом использовании AI-календаря для добавления подтверждённых событий в выбранный календарь Work или Personal
